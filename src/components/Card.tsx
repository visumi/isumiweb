...
const Card: FC<CardProps> = ({ title, icon, data }: CardProps) => {
  ...
  return (
    <div>
      ...
      <p className="font-serif font-bold text-black text-3xl mt-2 mb-6 text-center select-none">{title}</p>
      {
        data.map((d) => (
          <div key={d.subtitle} className="mt-6">
            ...
            <p className="font-sans font-semibold text-black text-xl text-center">{d.subtitle}</p>
