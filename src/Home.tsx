    ...
    <Transition appear show={isShowing}>
      <div>
        <div className="flex flex-grow justify-between">
          ...
          >
            <div
              className="px-4 text-center pt-10
          md:pt-0 md:px-0 lg:text-left md:mx-48 md:my-8 lg:px-0 xl:my-56 lg:ml-72 xl:ml-48"
            >
              <p className="font-serif font-black text-black text-6xl">
                Vinícius Isumi
              </p>
              <p className="font-serif font-bold text-gray-800 text-3xl my-2 select-none">
                Desenvolvedor Web
              </p>
              <p className="font-sans font-semibold text-gray-600 text-2xl max-w-md my-2 select-none">
                Formado em Análise de Sistemas pela UNICAMP, atuando com Angular e Java.
              </p>
              <div className="flex justify-center xl:justify-start space-x-14 pt-4 text-3xl">
                <a href="mailto: vinicius.isumi@gmail.com">
                  <FiAtSign
                    className="hover:transition duration-150 ease-in-out
